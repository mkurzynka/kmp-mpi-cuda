...
//        std::cin >> data_file_name;
        ...
        std::string text_data = readTextFile(data_file_name);
        text_length = text_data.length();

//        std::cout << "Enter pattern file name: " << std::endl;
//        std::cin >> pattern_file_name;
        pattern_file_name = "pattern.txt";
        pattern = readTextFile(pattern_file_name);
